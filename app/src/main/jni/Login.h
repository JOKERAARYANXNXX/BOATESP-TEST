// Don't Give this file to anyone 
#include "StrEnc.h"
#include "md5.h"
#include "json.hpp"
#include "Includes.h"
...
// =======================================================================================================        
    ...
    if (curl) {
        ...
        curl_easy_setopt(curl, CURLOPT_URL,  /*http://panel.sycheats.xyz/connect*/ StrEnc(OBFUSCATE("SW\\+b\\Oua}4:jw>HgK&E%F}(|:H{i5GMA"), "\x3B\x23\x28\x5B\x58\x73\x60\x05\x00\x13\x51\x56\x44\x04\x47\x2B\x0F\x2E\x47\x31\x56\x68\x05\x51\x06\x15\x2B\x14\x07\x5B\x22\x2E\x35", 33).c_str());
        ...
        char data[4096];
        sprintf(data, /*game=PUBG&user_key=%s&serial=%s*/ StrEnc(OBFUSCATE("qu2yXK,YkJyGD@ut0.u~Nb'5(:.:chK"), "\x16\x14\x5F\x1C\x65\x1B\x79\x1B\x2C\x6C\x0C\x34\x21\x32\x2A\x1F\x55\x57\x48\x5B\x3D\x44\x54\x50\x5A\x53\x4F\x56\x5E\x4D\x38", 31).c_str(), userKey, UUID.c_str());
