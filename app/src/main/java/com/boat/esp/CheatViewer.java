...
import static com.boat.esp.Overlay.getConfig;
...
public class CheatViewer extends View implements Runnable {
    ...
    public void InitializePaints() {		
        ...
        mNamePaint.setStrokeWidth(1.1f);
    }
 ...
 public void setFPS(int fps){
   ...
   public void DrawCircle2(Canvas cvs, int a, int r, int g, int b, float posX, float posY, float radius, float stroke) {
    ...
    public void DrawNameBot(Canvas cvs, int a, int r, int g, int b, String nametxt, int teamid, float posX, float posY, float size) {
        ...
        out = Bitmap.createScaledBitmap(bitmap, 30, 20, false);
        cvs.drawBitmap(out, posX - 50, posY - 25, null);
        mTextPaint.setColor(0x00000000);
        cvs.drawRect(posX - 75-Size, posY - 31 - Pos - Size, posX + 75+Size, posY -2 - Pos, mTextPaint);
        mTextPaint.setColor(0x0);
        cvs.drawRect(posX - 70-Size, posY - 18 - Pos-Size, posX - 45+Size, posY + 6 - Pos, mTextPaint);
        mTextPaint.setTextSize(16+Size);
        mTextPaint.setStrokeWidth(1f);
        mTextPaint.setColor(Color.WHITE);
        cvs.drawText("[AI]", posX, posY -10- Pos, mTextPaint);
        mTextPaint.setColor(0XFF03ecfc);
        mTextPaint.setStrokeWidth(1f);
