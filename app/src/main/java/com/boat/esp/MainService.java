...
public class MainService extends Service implements View.OnClickListener {
    ...
    void createOver(){
        ...
        final LinearLayout safe =mFloatingView.findViewById(R.id.safe);
        final LinearLayout MenuFB =mFloatingView.findViewById(R.id.MenuFB);
        ...
        final ImageView safeBtn=mFloatingView.findViewById(R.id.safeBtn);
        final ImageView MenuBtn=mFloatingView.findViewById(R.id.MenuBtn);
        playerBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                MenuFB.setVisibility(View.GONE);	
            }
        });
        ...
        MenuBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {               
                ...
                vehicle.setVisibility(View.GONE);
                safe.setVisibility(View.GONE);		
                MenuFB.setVisibility(View.VISIBLE);			
            }
        });
       ...
       private void FloatAim() {		   
		   mAimfloatView = LayoutInflater.from(this).inflate(R.layout.aimfloat, null);
		   int LAYOUT_FLAG;
		   if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
			   LAYOUT_FLAG = WindowManager.LayoutParams.TYPE_APPLICATION_OVERLAY;
        ...
        params.x = 100;
        params.y = 100;
	    mWindowManager.addView(mAimfloatView, params);
	   final View aimfloat = mAimfloatView.findViewById(R.id.aimfloat_container);
	   final ImageView aimicon = mAimfloatView.findViewById(R.id.aimicon);

        mAimfloatView.setOnTouchListener(new View.OnTouchListener() {
            private int initialX;
            private int initialY;
            private float initialTouchX;
            private float initialTouchY;
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        ...
                        if (trueAimSwitch) {
                            trueAimSwitch = false;
                            SettingValue(11,trueAimSwitch);
                            aimicon.setImageDrawable(getResources().getDrawable(R.mipmap.ic_aimbot_button_off));
                        } else {
                            int differenceX = (int) Math.abs(initialTouchX - event.getRawX());
                            int differenceY = (int) Math.abs(initialTouchY - event.getRawY());
                            if (differenceX < 10 && differenceY < 10 && aimfloat.getVisibility() == View.VISIBLE) {
                                trueAimSwitch = true;
                                SettingValue(11,trueAimSwitch);
                                aimicon.setImageDrawable(getResources().getDrawable(R.mipmap.ic_aimbot_button_on));
                            }
                        }
                        return true;
                    case MotionEvent.ACTION_MOVE:
                        params.x = initialX + (int) (event.getRawX() - initialTouchX);
                        params.y = initialY + (int) (event.getRawY() - initialTouchY);
                        mWindowManager.updateViewLayout(mAimfloatView, params);
                        return true;
                }
                return false;
            }
    ...
    private void FloatFlash() {		   
		   mFlashfloatView = LayoutInflater.from(this).inflate(R.layout.flashspeed, null);
		   int LAYOUT_FLAG;
		   if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
			   LAYOUT_FLAG = WindowManager.LayoutParams.TYPE_APPLICATION_OVERLAY;
        ...
        params.x = 100;
        params.y = 100;
	    mWindowManager.addView(mFlashfloatView, params);
	   final View flashspeed = mFlashfloatView.findViewById(R.id.flash_container);
       final View flashicon = mFlashfloatView.findViewById(R.id.flashicon);
		        
        mFlashfloatView.setOnTouchListener(new View.OnTouchListener() {
            private int initialX;
            private int initialY;
            private float initialTouchX;
            private float initialTouchY;
            ...
            public boolean onTouch(View v, MotionEvent event) {
                switch (event.getAction()) {
                    ...
                    case MotionEvent.ACTION_UP:
                        v.performClick();
                        if (trueFlashSwitch) {
                            trueFlashSwitch = false;
                            RunCPP("/" + Name2() + " 130");//case number
                            flashicon.setBackgroundTintList(ColorStateList.valueOf(Color.parseColor("#FFFFF700")));
                        } else {
                            int differenceX = (int) Math.abs(initialTouchX - event.getRawX());
                            int differenceY = (int) Math.abs(initialTouchY - event.getRawY());
                            if (differenceX < 10 && differenceY < 10 && flashspeed.getVisibility() == View.VISIBLE) {
                                trueFlashSwitch = true;
                                RunCPP("/" + Name2() + " 120");//case number
                                flashicon.setBackgroundTintList(ColorStateList.valueOf(Color.parseColor("#FFF1F1F1")));
                            }
                        }
                        return true;
                    case MotionEvent.ACTION_MOVE:
                        params.x = initialX + (int) (event.getRawX() - initialTouchX);
                        params.y = initialY + (int) (event.getRawY() - initialTouchY);
                        mWindowManager.updateViewLayout(mFlashfloatView, params);
                        return true;
                }
                return false;
            }
    ...
    public void onDestroy() {
        ...
        if (mFloatingView != null) mWindowManager.removeView(mFloatingView);
         ...
         if (mAimfloatView != null) {
            mWindowManager.removeView(mAimfloatView);
            mAimfloatView = null;    
        }        
           if (mFlashfloatView != null) {
            mWindowManager.removeView(mFlashfloatView);
            mFlashfloatView = null;
         }       
   ...
   final SeekBar range = mFloatingView.findViewById(R.id.range);
      ...
      final Switch aimbot = mFloatingView.findViewById(R.id.aimbot);        
       ...
       mWindowManager.removeView(mAimfloatView);
        ...
        //this is bypass 
		final Button bypass =mFloatingView.findViewById(R.id.bypass);
        bypass.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
              // only on for bypass
			  RunCPP("/" + Name4() + " 7");//case number
              bypass.setText("Activated");
            }
        });
        //termination fix
        ...
        norecoil.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
				...
				public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            	if (isChecked){		//on cpp						
				RunCPP("/" + Name2() + " 680");//case number
                } else { //off cpp
				RunCPP("/" + Name2() + " 690");//case number
       }}
    });
       // anti shake
        ...
        antishake.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
				...
				public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            	if (isChecked){		//on cpp						
				RunCPP("/" + Name2() + " 700");//case number
                } else { //off cpp
				RunCPP("/" + Name2() + " 710");//case number
       }}
    });
    // small Crosshair 
     final Switch smallSr = mFloatingView.findViewById(R.id.smallSr);        
        smallSr.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
				@Override
				public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            	if (isChecked){		//on cpp						
				RunCPP("/" + Name1() + " 10");//case number
                } else { //off cpp
				RunCPP("/" + Name1() + " 10");//case number
       }}
    });
    // wide view
	    final TextView textview_ipadview = mFloatingView.findViewById (R.id.textview_ipadview);
	    SeekBar seekbar_ipadview = mFloatingView.findViewById (R.id.seekbar_ipadview);
    	seekbar_ipadview.incrementProgressBy(10);
		seekbar_ipadview.setOnSeekBarChangeListener(new OnSeekBarChangeListener(){
				@Override
				public void onProgressChanged(SeekBar p1, int progress, boolean p3) {
					progress = progress / 1;
					progress = progress * 1;
					textview_ipadview.setText(String.valueOf(progress));
				}
				@Override
		...
		seekbar_ipadview.setProgress(0);
		textview_ipadview.setText(String.valueOf(seekbar_ipadview.getProgress()));


    // no fog
    final Switch nofog = mFloatingView.findViewById(R.id.nofog);        
        nofog.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
				@Override
				public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            	if (isChecked){		//on cpp						
				RunCPP("/" + Name2() + " 840");//case number
                } else { //off cpp
				RunCPP("/" + Name2() + " 850");//case number
       }}
    });
    // no grass
    final Switch nograss = mFloatingView.findViewById(R.id.nograss);        
        nograss.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
				@Override
				public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            	if (isChecked){		//on cpp						
				RunCPP("/" + Name2() + " 860");//case number
                } else { //off cpp
				RunCPP("/" + Name2() + " 870");//case number
       }}
    });
    
     // black sky
    final Switch blacksky = mFloatingView.findViewById(R.id.blacksky);        
        blacksky.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
				@Override
				public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            	if (isChecked){		//on cpp						
				RunCPP("/" + Name1() + " 1");//case number
                } else { //off cpp
				RunCPP("/" + Name1() + " 2");//case number
       }}
    });
    
     // black body 
    final Switch blackbody = mFloatingView.findViewById(R.id.blackbody);        
        blackbody.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
				@Override
				public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            	if (isChecked){		//on cpp						
				RunCPP("/" + Name2() + " 560");//case number
                } else { //off cpp
				RunCPP("/" + Name2() + " 561");//case number
       }}
    });
    
      // night mode
    final Switch nightmode = mFloatingView.findViewById(R.id.nightmode);        
        nightmode.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
				@Override
				public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            	if (isChecked){		//on cpp						
				RunCPP("/" + Name1() + " 3");//case number
                } else { //off cpp
				RunCPP("/" + Name1() + " 4");//case number
       }}
    });
    
	//headshot 
	final Switch headshot = mFloatingView.findViewById(R.id.headshot);        
        headshot.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
				@Override
				public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            	if (isChecked){		//on cpp						
				RunCPP("/" + Name2() + " 160");//case number
                } else { //off cpp
				RunCPP("/" + Name2() + " 170");//case number
       }}
    });
	
	//insta 
	final Switch insta = mFloatingView.findViewById(R.id.insta);        
        insta.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
				@Override
				public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            	if (isChecked){		//on cpp						
				RunCPP("/" + Name2() + " 200");//case number
                } else { //off cpp
				RunCPP("/" + Name2() + " 210");//case number
       }}
    });
	
	//xhit
	
		final Switch xhit = mFloatingView.findViewById(R.id.xhit);        
        xhit.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
				@Override
				public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            	if (isChecked){		//on cpp						
				RunCPP("/" + Name2() + " 140");//case number
                } else { //off cpp
				RunCPP("/" + Name2() + " 150");//case number
       }}
    });
	
	//xv2
		final Switch xhitz = mFloatingView.findViewById(R.id.xhitz);        
        xhitz.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
				@Override
				public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            	if (isChecked){		//on cpp						
				RunCPP("/" + Name2() + " 570");//case number
                } else { //off cpp
				RunCPP("/" + Name2() + " 580");//case number
       }}
    });
	
	//car
		final Switch speedcar = mFloatingView.findViewById(R.id.speedcar);        
        speedcar.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
				@Override
				public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            	if (isChecked){		//on cpp						
				RunCPP("/" + Name2() + " 310");//case number
                } else { //off cpp
				RunCPP("/" + Name2() + " 320");//case number
       }}
    });
	
	
	//stand scope
		final Switch sscode = mFloatingView.findViewById(R.id.sscode);        
        sscode.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
				@Override
				public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            	if (isChecked){		//on cpp						
				RunCPP("/" + Name2() + " 240");//case number
                } else { //off cpp
				RunCPP("/" + Name2() + " 250");//case number
       }}
    });
	
	//sit scope 
		final Switch sitcope = mFloatingView.findViewById(R.id.sitcope);        
        sitcope.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
				@Override
				public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            	if (isChecked){		//on cpp						
				RunCPP("/" + Name2() + " 220");//case number
                } else { //off cpp
				RunCPP("/" + Name2() + " 230");//case number
       }}
    });
	
	//prone scopr
		final Switch pronescope = mFloatingView.findViewById(R.id.pronescope);        
        pronescope.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
				@Override
				public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            	if (isChecked){		//on cpp						
				RunCPP("/" + Name2() + " 720");//case number
                } else { //off cpp
				RunCPP("/" + Name2() + " 730");//case number
       }}
	});
	//tree
		final Switch notree = mFloatingView.findViewById(R.id.notree);        
        notree.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
				@Override
				public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            	if (isChecked){		//on cpp						
				RunCPP("/" + Name2() + " 12");//case number
                } else { //off cpp
				RunCPP("/" + Name2() + " 61");//case number
       }}
    });
	
	
	//para v2
			final Switch paras = mFloatingView.findViewById(R.id.paras);        
        paras.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
				@Override
				public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            	if (isChecked){		//on cpp						
				RunCPP("/" + Name2() + " 420");//case number
                } else { //off cpp
				RunCPP("/" + Name2() + " 430");//case number
       }}
    });
	
	
	
			final Switch gudvew = mFloatingView.findViewById(R.id.gudvew);        
        gudvew.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
				@Override
				public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            	if (isChecked){		//on cpp						
				RunCPP("/" + Name2() + " 740");//case number
                } else { //off cpp
				RunCPP("/" + Name2() + " 750");//case number
       }}
    });
    
    	
			final Switch flass = mFloatingView.findViewById(R.id.flass);        
        flass.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
				@Override
				public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            	 if (isChecked){
						FloatFlash();									
			...
			final Switch dixflas = mFloatingView.findViewById(R.id.dixflas);        
        dixflas.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
				@Override
				public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
            	if (isChecked){		//on cpp						
				RunCPP("/" + Name2() + " 50");//case number
                } else { //off cpp
				RunCPP("/" + Name2() + " 60");//case number
       }}
    });
        ...
        //termination fix
        final Switch termination = mFloatingView.findViewById(R.id.termination);        
        termination.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
				@Override
				public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {            			
						if (isChecked){		//on cpp						
				RunCPP("/" + Name5());//just add sh file name          
	       		 } else { //off cpp
			
				 RunCPP("/" + Name6());//case number
